...
@section('content')
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-primary mb-3" onclick="window.location.href='{{ route('sales.index') }}'">
            See Sales History
        </button>
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" id="payNow" class="btn btn-success w-100 mt-3">
                            Pay Now
                        </button>
...
<script>
    ...
    $(document).on('click', '.add-to-cart', function () {
        ...
        if (existingItem) {
            if (existingItem.qty < existingItem.stock) {
                ...
                Swal.fire('Stock limit', 'Quantity cannot be more than available stock.', 'warning');
            }
        } else {
            cartItems.push({
                id: id,
    ...
    $(document).on('click', '#payNow', function () {
        if (cartItems.length === 0) {
            Swal.fire('Cart is empty', 'Please add items to the cart before proceeding to payment.', 'warning');
            return;
        }
        ...
        Swal.fire({
            ...
            text: 'Stock will be reduced after this transaction.',
            icon: 'question',
